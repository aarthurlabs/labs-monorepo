  ...
  return (
    <header className="border-b border-line bg-bg">
      <div className="flex min-h-14 flex-wrap items-center gap-x-space-4 gap-y-space-2 px-space-4 py-space-2 sm:px-space-6">
        ...
        <span className="inline-flex items-center gap-space-2 font-mono text-label text-text-muted">
          <span aria-hidden="true" className="size-[6px] rounded-pill bg-text-muted" />
          Não salvo
        </span>
